...
class AppWrapperView(ipw.VBox):
    ...
    def __init__(self) -> None:
        ...
        from aiidalab_widgets_base.infobox import InfoBox, FirstTimeUserMessage
        ...
        self.first_time_user_message = FirstTimeUserMessage("""
            <p>
                For <strong>new users</strong>,
                click on the <strong>"Guide"</strong> button below for tutorials.
            </p>
        """)
