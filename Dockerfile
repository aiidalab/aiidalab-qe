...
# #
# # Copy the conda env from qe_conda_env and run the final setup:
# #
...
#     # Codes: pythonjob, bader, wannier90
#     # On arm64, bader might not be installed yet. We do '|| true' to avoid error if it’s missing.
#     verdi code create core.code.installed --label python --computer=localhost \
#       --default-calc-job-plugin pythonjob.pythonjob --filepath-executable=/opt/conda/bin/python -n && \
#     verdi code create core.code.installed --label bader --computer=localhost \
#       --default-calc-job-plugin bader.bader --filepath-executable=${QE_DIR}/bin/bader -n || true && \
#     verdi code create core.code.installed --label wannier90 --computer=localhost \
#       --default-calc-job-plugin wannier90.wannier90 --filepath-executable=/opt/conda/bin/wannier90.x -n && \
#     # Post-install
#     python -m aiida_bader post-install || true && \
...
#     # Archive the entire home directory except "work" and ".conda"
...
# Install plugin(s) in final image
# RUN pip install aiida-bader \
#     git+https://github.com/mikibonacci/aiidalab-qe-vibroscopy@v1.2.0 \
#     git+https://github.com/mikibonacci/aiidalab-qe-muon@v1.0.0

# Copy hq binary from home_build
...
#
# Copy the final scripts, clean up home directory, and store the home.tar
#
