"""Legacy report for the `QeAppWorkChain`, only used for the old workchains run before QeApp version < 23.10
"""
...
def generate_report_html(qeapp_wc):
    ...
    This is the legacy version of the function, which is used for the old workchains run  QeApp version < 23.10
    """
